...
namespace MyRoom.Data
{
    ...
    /// </remarks>
    public class MyRoomUow : IMyRoomUow, IDisposable
    {
        public MyRoomUow(IRepositoryProvider repositoryProvider)
        {
            CreateDbContext();
        ...
        public IRepository<Hotel> Hotels { get { return GetStandardRepo<Hotel>(); } }
        public IRepository<Module> Modules { get { return GetStandardRepo<Module>(); } }
        public IRepository<Category> Categories { get { return GetStandardRepo<Category>(); } }
        public IRepository<Catalogue> Catalogues { get { return GetStandardRepo<Catalogue>(); } }
        ...
        private MyRoomDbContext DbContext { get; set; }
