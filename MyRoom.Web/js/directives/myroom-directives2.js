    ...
    app.directive('catalogSelect', function() {
        return {
            ...
            controller: function($scope, catalogService, $state) {
                $scope.selectActionCatalog = function(cata) {
                    ...
                    if ($scope.handleLoadedCatalog)
                        $scope.handleLoadedCatalog(cata.id);
      ...
      app.directive('hotelSelect', function () {
          return {
              ...
              controller: function ($scope, hotelService, $filter, $state) {
                  angular.element(document).ready(function () {
                    ...
                    if ($scope.dependends)
                    {
                        ...
                        {
                            hotelService.getHotelCatalogId($scope.cata.selected.id).then(function(response) {
